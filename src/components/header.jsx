...
const Header = ({ userType = 'student', userName = 'SkillMentor' }) => {
  ...
  const handleLogout = () => {
    ...
    // localStorage.removeItem('token'); // Uncomment if you're using tokens
            ...
            <div className="p-6">
              ...
              <div className="flex space-x-3">
                ...
                <button
                  ...
                  className="flex-1 bg-red-500 hover:bg-red-600 text-white font-medium py-3 px-4 rounded-lg transition-all duration-200"
                >
                  Yes, Logout
                </button>
              </div>
